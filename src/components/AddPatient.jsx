      ...
      <Modal>
        ...
        >
          <Form>
            ...
            {/* preReceivedAmountInputs */}
            {
              isPreReceived && (
                <div className="preReveivedInputDiv">
                  <div className="mt-3">
                    <label htmlFor="receivedAmount" className='form-label'>Received Amount:</label>
                    <Field type="number" name="receivedAmount" className="form-control" placeholder="Enter received amount..." />
                    <ErrorMessage name='receivedAmount' />
                  </div>
                  <div className="mt-3">
                    <label htmlFor="preReceivedAmount" className='form-label'>Pre Received Amount:</label>
                    <Field type="number" name="preReceivedAmount" className="form-control" placeholder="Enter received amount..." />
                    <ErrorMessage name='preReceivedAmount' />
                  </div>
                  <div className="mt-3">
                    <label htmlFor="balanceAmount" className='form-label'>Balance Amount:</label>
                    <Field type="number" name="balanceAmount" className="form-control" placeholder="Enter received amount..." />
                    <ErrorMessage name='balanceAmount' />
                  </div>
                </div>
              )
            }

            {/* end  preReceivedAmountInputs*/}
